...
lt.plugins.gitlight.tests.status.back.change_filenames = (function change_filenames(filename,x){return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__9377_SHARP_){if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"filename","filename",4574102905),p1__9377_SHARP_))
{return filename;
} else
{return p1__9377_SHARP_;
}
}),x));
});
lt.plugins.gitlight.tests.status.back.test_data = (function test_data(pair){var vec__9381 = pair;var n = cljs.core.nth.call(null,vec__9381,0,null);var what = cljs.core.nth.call(null,vec__9381,1,null);var vec__9382 = what;var tst = cljs.core.nth.call(null,vec__9382,0,null);var parsed = cljs.core.nth.call(null,vec__9382,1,null);var vec__9383 = tst;var X = cljs.core.nth.call(null,vec__9383,0,null);var Y = cljs.core.nth.call(null,vec__9383,1,null);var filename = cljs.core.nth.call(null,vec__9383,2,null);var d = cljs.core.nth.call(null,lt.plugins.gitlight.tests.status.back.data,n);var what_should_be = cljs.core.sort.call(null,cljs.core.map.call(null,cljs.core.partial.call(null,lt.plugins.gitlight.tests.status.back.change_filenames,filename),d));var what_is = cljs.core.sort.call(null,parsed);return cljs.core._EQ_.call(null,what_should_be,what_is);
});
lt.plugins.gitlight.tests.status.back.generate_test_data = (function generate_test_data(){var iter__7466__auto__ = (function iter__9390(s__9391){return (new cljs.core.LazySeq(null,(function (){var s__9391__$1 = s__9391;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__9391__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var x = cljs.core.first.call(null,xs__4579__auto__);var iterys__7462__auto__ = ((function (s__9391__$1,x,xs__4579__auto__,temp__4092__auto__){
return (function iter__9392(s__9393){return (new cljs.core.LazySeq(null,((function (s__9391__$1,x,xs__4579__auto__,temp__4092__auto__){
return (function (){var s__9393__$1 = s__9393;while(true){
var temp__4092__auto____$1 = cljs.core.seq.call(null,s__9393__$1);if(temp__4092__auto____$1)
{var s__9393__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__9393__$2))
{var c__7464__auto__ = cljs.core.chunk_first.call(null,s__9393__$2);var size__7465__auto__ = cljs.core.count.call(null,c__7464__auto__);var b__9395 = cljs.core.chunk_buffer.call(null,size__7465__auto__);if((function (){var i__9394 = 0;while(true){
if((i__9394 < size__7465__auto__))
{var y = cljs.core._nth.call(null,c__7464__auto__,i__9394);cljs.core.chunk_append.call(null,b__9395,(function (){var filename = lt.plugins.gitlight.tests.status.back.random_str.call(null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y,filename], null),lt.plugins.gitlight.status.back.get_status_for_line.call(null,[cljs.core.str(x),cljs.core.str(y),cljs.core.str(" "),cljs.core.str(filename)].join(''))], null);
})());
{
var G__9396 = (i__9394 + 1);
i__9394 = G__9396;
continue;
}
} else
...
{var y = cljs.core.first.call(null,s__9393__$2);return cljs.core.cons.call(null,(function (){var filename = lt.plugins.gitlight.tests.status.back.random_str.call(null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y,filename], null),lt.plugins.gitlight.status.back.get_status_for_line.call(null,[cljs.core.str(x),cljs.core.str(y),cljs.core.str(" "),cljs.core.str(filename)].join(''))], null);
})(),iter__9392.call(null,cljs.core.rest.call(null,s__9393__$2)));
}
} else
{return null;
}
...
});})(s__9391__$1,x,xs__4579__auto__,temp__4092__auto__))
,null,null));
});})(s__9391__$1,x,xs__4579__auto__,temp__4092__auto__))
...
{return cljs.core.concat.call(null,fs__7463__auto__,iter__9390.call(null,cljs.core.rest.call(null,s__9391__$1)));
} else
{{
var G__9397 = cljs.core.rest.call(null,s__9391__$1);
s__9391__$1 = G__9397;
continue;
}
}
...
lt.plugins.gitlight.tests.status.back.__BEH__test_git_status__DOT__out = (function __BEH__test_git_status__DOT__out(obj,data){return cljs.core.print.call(null,data.toString());
});
