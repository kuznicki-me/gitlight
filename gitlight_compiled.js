...
lt.plugins.gitlight.tests.status.back.change_filenames = (function change_filenames(filename,x){return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__10623_SHARP_){if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"filename","filename",4574102905),p1__10623_SHARP_))
{return filename;
} else
...
lt.plugins.gitlight.tests.status.back.test_data = (function test_data(pair){var vec__10627 = pair;var n = cljs.core.nth.call(null,vec__10627,0,null);var what = cljs.core.nth.call(null,vec__10627,1,null);var vec__10628 = what;var tst = cljs.core.nth.call(null,vec__10628,0,null);var parsed = cljs.core.nth.call(null,vec__10628,1,null);var vec__10629 = tst;var X = cljs.core.nth.call(null,vec__10629,0,null);var Y = cljs.core.nth.call(null,vec__10629,1,null);var filename = cljs.core.nth.call(null,vec__10629,2,null);var d = cljs.core.nth.call(null,lt.plugins.gitlight.tests.status.back.data,n);var what_should_be = cljs.core.sort.call(null,cljs.core.map.call(null,cljs.core.partial.call(null,lt.plugins.gitlight.tests.status.back.change_filenames,filename),d));var what_is = cljs.core.sort.call(null,parsed);return cljs.core._EQ_.call(null,what_should_be,what_is);
});
lt.plugins.gitlight.tests.status.back.generate_test_data = (function generate_test_data(){var iter__7466__auto__ = (function iter__10636(s__10637){return (new cljs.core.LazySeq(null,(function (){var s__10637__$1 = s__10637;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__10637__$1);if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;var x = cljs.core.first.call(null,xs__4579__auto__);var iterys__7462__auto__ = ((function (s__10637__$1,x,xs__4579__auto__,temp__4092__auto__){
return (function iter__10638(s__10639){return (new cljs.core.LazySeq(null,((function (s__10637__$1,x,xs__4579__auto__,temp__4092__auto__){
return (function (){var s__10639__$1 = s__10639;while(true){
var temp__4092__auto____$1 = cljs.core.seq.call(null,s__10639__$1);if(temp__4092__auto____$1)
{var s__10639__$2 = temp__4092__auto____$1;if(cljs.core.chunked_seq_QMARK_.call(null,s__10639__$2))
{var c__7464__auto__ = cljs.core.chunk_first.call(null,s__10639__$2);var size__7465__auto__ = cljs.core.count.call(null,c__7464__auto__);var b__10641 = cljs.core.chunk_buffer.call(null,size__7465__auto__);if((function (){var i__10640 = 0;while(true){
if((i__10640 < size__7465__auto__))
{var y = cljs.core._nth.call(null,c__7464__auto__,i__10640);cljs.core.chunk_append.call(null,b__10641,(function (){var filename = lt.plugins.gitlight.tests.status.back.random_str.call(null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y,filename], null),lt.plugins.gitlight.status.back.get_status_for_line.call(null,[cljs.core.str(x),cljs.core.str(y),cljs.core.str(" "),cljs.core.str(filename)].join(''))], null);
})());
{
...
{var y = cljs.core.first.call(null,s__10639__$2);return cljs.core.cons.call(null,(function (){var filename = lt.plugins.gitlight.tests.status.back.random_str.call(null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y,filename], null),lt.plugins.gitlight.status.back.get_status_for_line.call(null,[cljs.core.str(x),cljs.core.str(y),cljs.core.str(" "),cljs.core.str(filename)].join(''))], null);
})(),iter__10638.call(null,cljs.core.rest.call(null,s__10639__$2)));
}
} else
{return null;
}
...
});})(s__10637__$1,x,xs__4579__auto__,temp__4092__auto__))
,null,null));
});})(s__10637__$1,x,xs__4579__auto__,temp__4092__auto__))
...
{return cljs.core.concat.call(null,fs__7463__auto__,iter__10636.call(null,cljs.core.rest.call(null,s__10637__$1)));
} else
{{
var G__10643 = cljs.core.rest.call(null,s__10637__$1);
s__10637__$1 = G__10643;
continue;
}
}
} else
...
lt.plugins.gitlight.tests.status.back.__BEH__git_test_repo__DOT__out = (function __BEH__git_test_repo__DOT__out(obj,data){return lt.plugins.gitlight.tests.status.back.test_git_status.call(null,data.toString());
});
...
lt.plugins.gitlight.tests.status.back.test_git_status_out = lt.object.create.call(null,lt.object.object_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gitlight.tests.status.back","test-git-status-out","lt.plugins.gitlight.tests.status.back/test-git-status-out",4522134867),new cljs.core.Keyword(null,"tags","tags",1017456523),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"test-git-status-out","test-git-status-out",2760717787)], null),new cljs.core.Keyword(null,"behaviors","behaviors",607554515),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("lt.plugins.gitlight.tests.status.back","test-git-status.out","lt.plugins.gitlight.tests.status.back/test-git-status.out",4522827762)], null)));
lt.plugins.gitlight.tests.status.back.status_regexp = /## master\n( M not-staged-...\n){5}(M  staged-...\n){5}(\?\? untracked-...\n){5}/;
lt.plugins.gitlight.tests.status.back.__BEH__test_git_status__DOT__out = (function __BEH__test_git_status__DOT__out(obj,data){return cljs.core.print.call(null,!((cljs.core.re_matches.call(null,lt.plugins.gitlight.tests.status.back.status_regexp,data.toString()) == null)));
});
